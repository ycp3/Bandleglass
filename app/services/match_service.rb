  ...
  def self.create_match(region:, match_data:)
    ...
    match_data["participants"].each do |participant_data|
      ...
      RunePage.create!(
        ...
        row_1_id: primary_tree_data["selections"][1]["perk"],
        row_2_id: primary_tree_data["selections"][2]["perk"],
        row_3_id: primary_tree_data["selections"][3]["perk"],
        secondary_tree_id: secondary_tree_data["style"],
        secondary_rune_1_id: secondary_tree_data["selections"][0]["perk"],
        secondary_rune_2_id: secondary_tree_data["selections"][1]["perk"],
